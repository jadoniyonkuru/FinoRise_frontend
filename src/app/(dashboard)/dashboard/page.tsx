        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-10">
          <div className="space-y-4">
            ...
            <div className="flex gap-4 pt-4">
              <Button asChild size="lg" className="h-14 px-8 font-bold bg-primary hover:bg-primary/90 shadow-xl shadow-primary/20">
                <Link href="/simulations">Continue Simulation</Link>
              </Button>
              <Button variant="outline" size="lg" className="h-14 px-8 font-bold border-black/10 glass">View Progress</Button>
            </div>
          </div>
          <div className="flex gap-6 md:gap-12">
            <div className="text-center">
              <div className="w-20 h-20 rounded-[1.5rem] white-card flex items-center justify-center mb-4 mx-auto">
                <Zap className="w-10 h-10 text-primary" />
              </div>
              <p className="text-[10px] font-bold uppercase text-muted-foreground tracking-widest">Daily Streak</p>
              <p className="text-3xl font-bold font-headline">7 Days</p>
            </div>
            <div className="text-center">
              <div className="w-20 h-20 rounded-[1.5rem] white-card flex items-center justify-center mb-4 mx-auto">
                <Award className="w-10 h-10 text-[#FFBF00]" />
              </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
        ...
        <div className="lg:col-span-2 space-y-10">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <Card className="white-card rounded-3xl overflow-hidden p-2">
              ...
              <CardContent className="space-y-6">
                <div className="flex items-end justify-between">
                  <span className="text-4xl font-bold font-headline">72%</span>
                  <span className="text-xs font-bold text-muted-foreground">+5% from last week</span>
                </div>
            ...
            <Card className="white-card rounded-3xl overflow-hidden p-2">
              <CardHeader className="pb-4">
                <CardTitle className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest flex items-center justify-between">
                  Financial Score
                  <Target className="w-4 h-4 text-[#FFBF00]" />
                </CardTitle>
              </CardHeader>
              <CardContent className="space-y-6">
                <div className="flex items-end justify-between">
                  <span className="text-4xl font-bold font-headline">840</span>
          ...
          <div className="space-y-6">
            <div className="flex items-center justify-between">
              ...
              <Button variant="link" asChild className="text-primary font-bold px-0 text-base">
                <Link href="/learning">View All Modules</Link>
              </Button>
            </div>
            
            <Card className="white-card rounded-[2rem] overflow-hidden group">
              <div className="flex flex-col md:flex-row h-full">
                ...
                <div className="flex-1 p-10 space-y-6">
                  <div className="flex items-center justify-between">
                    <span className="text-xs font-bold text-primary uppercase tracking-widest">Investing Basics</span>
                    <span className="text-xs font-bold text-muted-foreground">15 mins</span>
                  </div>
                  <h3 className="font-headline font-bold text-2xl group-hover:text-primary transition-colors text-secondary">Diversification & Allocation</h3>
                  <p className="text-base text-muted-foreground leading-relaxed">
                    Learn how to spread risk across different asset classes to protect your long-term wealth.
                  </p>
                  <div className="flex items-center gap-6 pt-2">
                    <Button size="lg" className="h-12 px-6 font-bold bg-primary shadow-lg shadow-primary/20">
                      <Play className="w-4 h-4 mr-2 fill-current" />
                      Start Lesson
                    </Button>
                    <span className="text-sm text-primary font-bold uppercase tracking-wider">+150 XP Reward</span>
                  </div>
                </div>
              </div>
            </Card>
        ...
        <div className="space-y-10">
          <Card className="white-card rounded-3xl p-2">
            <CardHeader className="pb-4">
              <CardTitle className="text-xl font-bold text-secondary">AI Coach Insights</CardTitle>
              <CardDescription className="text-sm font-bold">Based on your last session</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="p-6 rounded-2xl bg-primary/5 border border-primary/10">
                <p className="text-base italic text-secondary leading-relaxed font-medium">
                  "You showed strong resilience in the 'Emergency Fund' scenario, but your impulsive reaction cost you 12% in potential gains."
                </p>
              </div>
              <Button variant="outline" size="lg" className="w-full h-14 font-bold border-black/10 glass" asChild>
            ...
            <CardContent className="space-y-6">
              {[
                ...
                <div key={i} className="flex items-center gap-4 group cursor-pointer">
                  <div className="w-14 h-14 rounded-2xl bg-black/5 flex items-center justify-center shrink-0 border border-black/5 group-hover:bg-primary/5 transition-colors">
              ...
              <Button variant="ghost" className="w-full h-12 text-sm font-bold text-muted-foreground hover:text-black uppercase tracking-widest">
                View All 24
              </Button>
            </CardContent>
          </Card>
