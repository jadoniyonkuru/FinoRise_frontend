        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-10">
          <div className="space-y-4">
            ...
            <div className="flex gap-4 pt-4">
              <Button asChild size="lg" className="h-14 px-8 font-bold bg-primary hover:bg-secondary text-white shadow-xl shadow-primary/20 rounded-2xl">
                <Link href="/simulations">Continue Simulation</Link>
              </Button>
              <Button variant="outline" size="lg" className="h-14 px-8 font-bold border-black/10 glass hover:bg-secondary hover:text-white rounded-2xl">View Progress</Button>
            </div>
          </div>
          <div className="flex gap-6 md:gap-12">
            <div className="text-center">
              <div className="w-20 h-20 rounded-[1.5rem] white-card flex items-center justify-center mb-4 mx-auto hover:bg-secondary group transition-all">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
        ...
        <div className="lg:col-span-2 space-y-10">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <Card className="white-card rounded-3xl overflow-hidden p-2 hover:bg-secondary hover:text-white group transition-all duration-300">
          ...
          <div className="space-y-6">
            <div className="flex items-center justify-between">
              ...
              <Button variant="link" asChild className="text-primary font-bold px-0 text-base hover:text-secondary">
                <Link href="/learning">View All Modules</Link>
              </Button>
            </div>
            
            <Card className="white-card rounded-[2rem] overflow-hidden group hover:bg-secondary hover:text-white transition-all duration-500">
              <div className="flex flex-col md:flex-row h-full">
                ...
                <div className="flex-1 p-10 space-y-6">
                  ...
                  <div className="flex items-center gap-6 pt-2">
                    <Button size="lg" className="h-12 px-6 font-bold bg-primary hover:bg-white hover:text-black shadow-lg shadow-primary/20 rounded-xl transition-all">
                      <Play className="w-4 h-4 mr-2 fill-current" />
                      Start Lesson
                    </Button>
                    <span className="text-sm text-[#FFBF00] font-bold uppercase tracking-wider">+150 XP Reward</span>
                  </div>
                </div>
              </div>
            </Card>
        ...
        <div className="space-y-10">
          <Card className="white-card rounded-3xl p-2 hover:bg-secondary hover:text-white group transition-all duration-300">
            <CardHeader className="pb-4">
            ...
            <CardContent className="space-y-6">
              <div className="p-6 rounded-2xl bg-primary/5 border border-primary/10 group-hover:bg-white/5 transition-colors">
              ...
              <Button variant="outline" size="lg" className="w-full h-14 font-bold border-black/10 glass hover:bg-white hover:text-black rounded-2xl transition-all" asChild>
          ...
          <Card className="white-card rounded-3xl p-2">
            ...
            <CardContent className="space-y-6">
              ...
              <Button variant="ghost" className="w-full h-12 text-sm font-bold text-muted-foreground hover:text-secondary uppercase tracking-widest">
                View All 24
              </Button>
            </CardContent>
          </Card>
